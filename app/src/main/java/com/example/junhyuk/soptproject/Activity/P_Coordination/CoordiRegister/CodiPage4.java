...
public class CodiPage4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.codiregister_fragment_page4, container, false);
        ...
        temp.setClothImage("https://hell-bucket.s3.ap-northeast-2.amazonaws.com/1483247295463.png");
        closets.add(temp);
        temp = new Closet();
        temp.setClothImage("https://hell-bucket.s3.ap-northeast-2.amazonaws.com/1483247314581.png");
        closets.add(temp);
