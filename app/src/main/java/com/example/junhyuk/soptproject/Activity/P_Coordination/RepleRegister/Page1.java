...
public class Page1 extends Fragment {
    ...
    final View view = inflater.inflate(R.layout.repleregister_fragment_page1, container, false);
        ...
        temp.setClothImage("https://hell-bucket.s3.ap-northeast-2.amazonaws.com/1483243864089.jpeg");
        closets.add(temp);
        temp = new Closet();
        temp.setClothImage("https://hell-bucket.s3.ap-northeast-2.amazonaws.com/1483246020722.png");
        closets.add(temp);
        temp = new Closet();
