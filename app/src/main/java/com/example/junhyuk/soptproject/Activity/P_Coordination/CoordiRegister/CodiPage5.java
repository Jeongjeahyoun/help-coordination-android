...
public class CodiPage5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        final View view = inflater.inflate(R.layout.codiregister_fragment_page5, container, false);
        ...
        temp.setClothImage("https://hell-bucket.s3.ap-northeast-2.amazonaws.com/1483248771096.png");
        closets.add(temp);
        temp = new Closet();
        temp.setClothImage("http://cfile236.uf.daum.net/original/277FA64F51F722C426F079");
        closets.add(temp);
